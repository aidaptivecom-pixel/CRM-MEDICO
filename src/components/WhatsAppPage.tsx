...
const WhatsAppPage: React.FC = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch(status) {
      case 'new': return <span className="px-2 py-0.5 bg-red-100 text-red-700 rounded-lg text-xs font-medium">Nuevo</span>;
      case 'bot': return <span className="px-2 py-0.5 bg-emerald-100 text-emerald-700 rounded-lg text-xs font-medium flex items-center gap-1"><Bot size={10}/> Bot</span>;
      case 'human': return <span className="px-2 py-0.5 bg-blue-100 text-blue-700 rounded-lg text-xs font-medium flex items-center gap-1"><User size={10}/> Humano</span>;
      case 'resolved': return <span className="px-2 py-0.5 bg-gray-100 text-gray-600 rounded-lg text-xs font-medium">✓ Resuelto</span>;
      default: return null;
    }
  };
  ...
  return (
    <div className="flex h-[calc(100vh-200px)] bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
      <div className="w-80 border-r border-gray-100 flex flex-col">
        <div className="p-4 border-b border-gray-100">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="flex items-center gap-1 text-xs text-emerald-600 bg-emerald-50 px-2 py-1 rounded-xl">
          ...
          {filteredConversations.map(conv => (
            ...
            >
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-xl bg-gray-200 flex items-center justify-center text-gray-600 font-medium text-sm flex-shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {conv.unread > 0 && (
                      <span className="w-5 h-5 bg-emerald-500 text-white rounded-lg text-xs flex items-center justify-center flex-shrink-0">
                        {conv.unread}
                      </span>
                    )}
                  </div>
      ...
      <div className="flex-1 flex flex-col">
        <div className="p-4 border-b border-gray-100 flex items-center justify-between bg-white">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-emerald-100 flex items-center justify-center text-emerald-700 font-medium">
          ...
          <div className="flex items-center gap-2">
            {selectedChat.status === 'bot' && (
              <button className="flex items-center gap-2 px-3 py-1.5 bg-blue-50 text-blue-700 rounded-xl text-sm font-medium hover:bg-blue-100 transition-colors">
                <User size={14} />
                Tomar control
              </button>
            )}
            {selectedChat.status === 'human' && (
              <button className="flex items-center gap-2 px-3 py-1.5 bg-emerald-50 text-emerald-700 rounded-xl text-sm font-medium hover:bg-emerald-100 transition-colors">
                <Bot size={14} />
                Devolver a Bot
              </button>
            )}
        ...
        <div className="p-4 border-t border-gray-100 bg-white">
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              className="flex-1 px-4 py-2.5 bg-gray-100 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-100"
            />
            <button className="p-2.5 bg-emerald-500 hover:bg-emerald-600 rounded-2xl transition-colors">
